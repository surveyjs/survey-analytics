...
export var englishStrings = {
  ...
  pdfDownloadHint: "Export as PDF",
  xlsxDownloadHint: "Export as Excel",
  csvDownloadHint: "Export as CSV",
  ...
  reportingPeriodLast28days: "Last 28 days",
  reportingPeriodLast30days: "Last 30 days",
  reportingPeriodLastWeekMon: "Last week (starts Monday)",
  reportingPeriodLastWeekSun: "Last week (starts Sunday)",
  reportingPeriodLastMonth: "Last month",
  reportingPeriodLastQuarter: "Last quarter",
  reportingPeriodLastYear: "Last year",
  reportingPeriodWtdSun: "This week to date (starts Sunday)",
  reportingPeriodWtdMon: "This week to date (starts Monday)",
  reportingPeriodMtd: "This month to date",
  reportingPeriodQtd: "This quarter to date",
  reportingPeriodYtd: "This year to date",
