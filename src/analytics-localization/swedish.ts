...
export var swedishStrings = {
  groupButton: "Gruppera",
  ungroupButton: "Avgruppera",
  selectButton: "Välj",
  ...
  chartType_doughnut: "Ringdiagram",
  chartType_pie: "Cirkeldiagram",
  chartType_scatter: "Punktdiagram",
  chartType_gauge: "Mätare",
  chartType_bullet: "Bullet",
  chartType_line: "Linjediagram",
  chartType_radar: "Radardiagram",
  hideButton: "Göm",
  ...
  otherCommentTitle: "Andra objekt och kommentarer",
