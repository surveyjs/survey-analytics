...
test("WordCloudWidget render", () => {
  ...
  expect(renderTarget.querySelector(".sa-visualizer-wordcloud")).toBeTruthy();
  expect(renderTarget.innerHTML).toContain("title=\"word2 (10)\">word2");
  expect(renderTarget.innerHTML).toContain("title=\"word1 (2)\">word1");
  expect(renderTarget.innerHTML).toContain("height: 1649.9259536805148px");
  wcw.dispose();
